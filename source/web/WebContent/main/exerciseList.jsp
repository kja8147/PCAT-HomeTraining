<%@ page language="java" contentType="text/html; charset=EUC-KR" pageEncoding="EUC-KR" import="java.sql.*,java.text.SimpleDateFormat, java.util.Date"%>
<%@ page import="capstone.DBUtil" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>

<!-- written by 김진아, 김윤하 : 운동 선택 페이지 -->    
<%		
